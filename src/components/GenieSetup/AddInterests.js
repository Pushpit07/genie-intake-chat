...
const AddInterests = ({ formValues, onFieldChange, addCollaborator }) => {
	return (
		<>
			<div>
			...
			<div className="xl:w-1/3 lg:w-1/2 md:w-2/3 w-full flex flex-col gap-3 mt-4">
				<h2 className="text-base font-medium">Tell us about your interests</h2>
				<textarea
					type={"text"}
					rows={5}
			...
			<div className="w-full">
				<h2 className="text-base font-medium mb-2">Add interests one by one</h2>
					...
					{formValues.collaborators.map((collaborator, index) => (
						<div className="flex" key={index}>
							<TextInput
								...
								placeholder="Eg. Tech, Sports, Music, Photography, etc."
								required={false}
							/>
						</div>
					))}
